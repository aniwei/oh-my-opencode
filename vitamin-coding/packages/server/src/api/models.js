...
function resolveModelRegistry(input) {
...
function createModelsRouter(modelRegistry) {
    var _this = this;
    var router = (0, express_1.Router)();
    var registry = resolveModelRegistry(modelRegistry);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, registry.listModels()];
                case 1:
                    models = _a.sent();
